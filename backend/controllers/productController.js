...
exports.addProduct = async(req, res)=> {
    ...
    const {name, description, price, quantity, images, category, averageRating, reviews} = req.body;
    let product = new Product(name, description, price, quantity, images, category, averageRating, reviews);
    try{
